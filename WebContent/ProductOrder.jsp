...
<%
	...
	if (request.getHeader("referer") == null
		|| !request.getHeader("referer").equals(
			"http://localhost:8080/cse135/Browse.jsp")) {
...
<%
			...
			if (session.getAttribute("products") != null)
				products = (ArrayList<String>) session
...
<div>
	...
	<div>
		...
		<form action="Browse.jsp" method="POST">
			...
			<input type="hidden" value="<%=p_name%>" name="p_name" /> <label>Quantity</label>
			<input type="number" value="1" min="1" name="quantity" /><br> <input
